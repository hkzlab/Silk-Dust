...
# 29 "/opt/z8kgcc-jan-19-2009/lib/gcc-lib/z8k-pcos/2.9-ecosSWtools-990319-m20z8k-3/../../../../z8k-pcos/include/stdio.h" 2 3
...
# 45 "/opt/z8kgcc-jan-19-2009/lib/gcc-lib/z8k-pcos/2.9-ecosSWtools-990319-m20z8k-3/../../../../z8k-pcos/include/stdio.h" 2 3
...
# 46 "/opt/z8kgcc-jan-19-2009/lib/gcc-lib/z8k-pcos/2.9-ecosSWtools-990319-m20z8k-3/../../../../z8k-pcos/include/stdio.h" 2 3
...
# 1 "/opt/z8kgcc-jan-19-2009/lib/gcc-lib/z8k-pcos/2.9-ecosSWtools-990319-m20z8k-3/../../../../z8k-pcos/include/string.h" 1 3
...
# 14 "/opt/z8kgcc-jan-19-2009/lib/gcc-lib/z8k-pcos/2.9-ecosSWtools-990319-m20z8k-3/../../../../z8k-pcos/include/string.h" 2 3
...
void savegame(char *filename)  
{
    ...
    if(f== ((void *)0) ) {
        _pcos_dstring( "Error: can not open file " ) ;
        return;
    }
    fputs("SAVEDAWS2.1\n",f);

    fputs("Silk Dust, part 3" "\n",f);
...
void loadgame(char *filename)  
{
    ...
    if(f== ((void *)0) ) {
        _pcos_dstring( "Can not open file " ) ;
        return;
    }

    fgets(playerInput, 128 , f);
    if(strcmp(playerInput, "SAVEDAWS2.1\n")!=0) {
        _pcos_dstring( "Incorrect format " ) ;
        fclose(f);
        return;
    }
    fgets(playerInput, 128 , f);
    if(strcmp(eatcr(playerInput), "Silk Dust, part 3" )!=0) {
        _pcos_dstring( "Incorrect game: " ) ;
        _pcos_dstring( playerInput ) ;
        fclose(f);
        return;
    }
